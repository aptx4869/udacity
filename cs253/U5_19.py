...
xml = """
<HostipLookupResultSet xmlns:gml="http://www.opengis.net/gml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0.1" xsi:noNamespaceSchemaLocation="http://www.hostip.info/api/hostip-1.0.1.xsd">
...
def get_coords(xml):
    ...
    try:
        s=p.getElementsByTagName('gml:coordinates')[0].firstChild.data
        lon,lat=s.split(',')
        return lat,lon
    except:
        pass
