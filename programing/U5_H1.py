...
def Pwin3(me, you, pending):
    if me + pending >= goal:
        ...
        return max(Q_pig((0,me,you,pending), action, Pwin2)
                   for action in pig_actions((0,me,you,pending)))
...
print test()
print abs(Pwin2((0, 25, 32, 8)) - 0.736357188272)
#print abs(Pwin2((0, 19, 35, 4)) - 0.493173612834)
