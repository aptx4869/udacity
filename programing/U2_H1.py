...
def compile_formula(formula, verbose=True):
    ...
    body = ''.join(tokens)
    print 'body',body 
    leading = set(re.findall('[A-Z](?=\))', body))
    tail=''
    for char in leading:
        tail += ' and ' + char + '!=0'
    print 'leading',tail 
...
print test()
#faster_solve('A + B == BA') == None # should NOT return '1 + 0 == 01'
#faster_solve('YOU == ME**2') == ('289 == 17**2' or '576 == 24**2' or '841 == 29**2')
#print eval('lambda A,B:(1*A) + (1*B) == (1*A+10*B) and B!=0')(1,0)
