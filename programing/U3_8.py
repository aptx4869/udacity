...
def match(pattern, text):
    ...
    if remainders:
        ...
        #print remainders
        #print text.find(shortest)
        print text.rstrip(shortest)# your code here
        return text.rstrip(shortest)
        #return text.split(shortest)# your code here
