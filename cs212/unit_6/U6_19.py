...
prev_hand, prev_results = '', dict() # cache for find_prefixes
@trace
def find_prefixes(hand, pre='', results=None):
    """Find all prefixes (of words) that can be made from letters in hand."""
    global prev_hand
    if hand in prev_results and prev_hand==hand and pre=='':
        return prev_results[hand]
    ...
    prev_results[hand]=results
    prev_hand=hand
    return results


print find_prefixes('LETTER')
print find_prefixes('LETTER')
print find_prefixes('LETTER')
print find_prefixes('LETTER')
print find_prefixes('LETTR')

#print find_prefixes('TER','LET')
#print find_prefixes('TER','LET')
#print find_prefixes('LETTER')
